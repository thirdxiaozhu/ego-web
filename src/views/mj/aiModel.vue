...
console.log('!!!!!!!!!', nGptStore.value.model)
...
<template>
  <section class="mb-5 justify-between items-center">
    ...
    <NSelect v-model:value="nGptStore.model" class="change-select" :options="modellist" size="small" @update:value="onSelectChange1" />
  </section>
  ...
  <section class="mb-5 justify-between items-center">
    ...
    <NSelect v-model:value="nGptStore.kid" class="change-select" :options="options" size="small" @update:value="onSelectChange" />
  </section>
  ...
  <section class=" flex justify-between items-center">
    ...
    <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
      <div class=" w-[200px]">
        <NSlider v-model:value="nGptStore.talkCount" class="change-slider" :step="1" :max="50" />
      </div>
  ...
  <section class=" flex justify-between items-center">
    ...
    <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
      <div class=" w-[200px]">
        <NSlider v-model:value="nGptStore.max_tokens" class="change-slider" :step="1" :max="1280000" :min="1" />
      </div>
  ...
  <template v-if="st.openMore">
    <section class=" flex justify-between items-center ">
      ...
      <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
        <div class=" w-[200px]">
          <NSlider v-model:value="nGptStore.temperature" class="change-slider" :step="0.01" :max="1" />
        </div>
        <div class="w-[40px] text-right">
    ...
    <section class=" flex justify-between items-center ">
      ...
      <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
        <div class=" w-[200px]">
          <NSlider v-model:value="nGptStore.top_p" class="change-slider" :step="0.01" :max="1" />
        </div>
        <div class="w-[40px] text-right">
          {{ nGptStore.top_p }}
        </div>
    ...
    <section class=" flex justify-between items-center ">
      ...
      <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
        <div class=" w-[200px]">
          <NSlider v-model:value="nGptStore.presence_penalty" class="change-slider" :step="0.01" :max="1" />
        </div>
        <div class="w-[40px] text-right">
    ...
    <section class=" flex justify-between items-center ">
      ...
      <div class=" flex justify-end items-center w-[80%] max-w-[240px]">
        <div class=" w-[200px]">
          <NSlider v-model:value="nGptStore.frequency_penalty" class="change-slider" :step="0.01" :max="1" />
        </div>
        <div class="w-[40px] text-right">
