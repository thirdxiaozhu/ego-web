...
import { NButton, NInput, NSelect, NUpload, useMessage } from 'naive-ui'
...
const balance = ref(userInfo.value.userBalance ?? 0)
...
function updateUserName(nickName: string) {
  mlog('updateUserName', nickName)
  userStore.updateUserName(nickName)
  ...
  <div class="p-4 space-y-5 min-h-[200px]">
    <div class="space-y-6">
      <div class="flex items-center space-x-4">
        ...
        <NUpload
          action="/api/system/user/edit/avatar"
          :max="1"
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="w-[200px]">
          <!--          <NInput v-model:value="balance" placeholder="" /> -->
          {{ balance }}
        </div>
      </div>
